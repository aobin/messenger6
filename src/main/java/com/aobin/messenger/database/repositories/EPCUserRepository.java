package com.aobin.messenger.database.repositories;
...
public interface EPCUserRepository extends JpaRepository<EPCUser, Long>
{
  /**
  ...
  public EPCUser findByEmail(String email);
  
  @Query("SELECT p FROM EPCUser p WHERE p.email = ?1")
  public Page<EPCUser> findByEmail(String email, Pageable page);
  
  public EPCUser findOne(Long userId);
}
